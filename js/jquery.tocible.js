		...
		return this.each(function(){
			...
			heading.add(subheading).each(function() {
				...
				anchor.click(function(e) {
					...
					$('html, body').stop(true).animate({scrollTop:offset.top - 60}, opts.speed);
				});
			...
			contain = function(){
				...
				nav.css({'top':opts.offsetTop, 'bottom':'auto', 'right':left});
